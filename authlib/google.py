...
GOOGLE_OAUTH_STATE_SESSION_KEY = "google-oauth-state"
...
class GoogleOAuth2Client:
    ...
    def __init__(self, request, *, login_hint=None, authorization_params=None):
        ...
        self._state = request.session.pop(GOOGLE_OAUTH_STATE_SESSION_KEY, None)
    ...
    def get_authentication_url(self):
        ...
        self._request.session[GOOGLE_OAUTH_STATE_SESSION_KEY] = state
